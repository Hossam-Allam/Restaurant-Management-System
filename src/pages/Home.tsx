...
const Home = () => {
  ...
  if (
    Math.abs(deviceAspectRatio - 1980 / 1024) <
      Math.abs(deviceAspectRatio - 1024 / 1980) &&
    Math.abs(deviceAspectRatio - 1980 / 1024) < Math.abs(deviceAspectRatio)
  ) {
    firstVideoSrc = "/src/assets/a1980x1024.mp4";
    secondVideoSrc = "/src/assets/b1980x1024.mp4";
  } else if (
    Math.abs(deviceAspectRatio - 1024 / 1980) < Math.abs(deviceAspectRatio - 1)
  ) {
  ...
  const handleSignup = async () => {
    if (!email || !password || !phoneno || !address) {
  ...
  const smoothScroll = (targetId: string) => {
    ...
    const targetPosition =
      targetElement.getBoundingClientRect().top + startPosition - 1; // Adding a small offset
  ...
  const handleScroll = useCallback((e: WheelEvent) => {
    ...
    const currentSection = sections.findIndex((section) => {
      ...
      return (
        element && window.pageYOffset < element.offsetTop + element.offsetHeight
      );
    });
      ...
      <NextThemesProvider attribute="class" defaultTheme="dark">
              ...
              <>
                ...
                <ModalBody>
                  ...
                  <div className="flex py-2 px-1 justify-between">
                    ...
                    <Link color="primary" onClick={handleForgot} size="sm">
                      Forgot password?
                    </Link>
                  </div>
                </ModalBody>
            ...
            {(onClose) => (
              <>
                ...
                <ModalBody>
                  ...
                  />
                  <Select label="Select country" variant="bordered">
                    <SelectItem
                      key="turkey"
                      startContent={
                        <Avatar
        ...
        <div id="main">
          ...
          <div className="video-container">
            <video ref={firstVideoRef} autoPlay muted className="video">
        ...
        <div
          ...
          style={{
            backgroundImage: `url("/src/assets/purplebg.png")`,
        ...
        >
          <div className="flex justify-center items-center h-screen pb-16">
            {" "}
            {/* Added pb-16 for padding */}
            <div className="flex w-3/4">
              <div className="w-1/2">
                <h1
                  className="text-6xl font-bold bg-gradient-to-b from-blue-700 to-purple-500 bg-clip-text text-transparent"
                  style={{
                    textShadow: "0px 0px 40px rgba(248,47,257,0.275)",
                    paddingTop: "10vh",
                    paddingBottom: "5vh",
                  }}
                >
                ...
                <h2 className="w-full md:w-1/2 my-2 text-lg lg:text-xl font-normal text-default-500 block max-w-full !w-full text-center md:text-left">
                  Easy to use, and convenient restaurant managament system.
                </h2>
                <div
                ...
                >
                  ...
                  >
                    ...
                    <CardBody>
                      <p>
                        Track your stock levels and manage orders efficiently.
                      </p>
                    </CardBody>
                  </Card>
                  <Card
                  ...
                  >
                    ...
                    <CardBody>
                      <p>
                        Collect and analyze customer feedback to improve
                        service.
                      </p>
                    </CardBody>
                  </Card>
                  ...
                  >
                    ...
                    <CardBody>
                      <p>
                        Effortlessly oversee team dynamics and streamline
                  ...
                  >
                    ...
                    <CardBody>
                      <p>
                        Get detailed reports on sales and performance metrics.
                      </p>
                    </CardBody>
                  </Card>
                </div>
          ...
          <div
            ...
            className="relative h-screen"
            style={{
              backgroundImage: `url("/src/assets/cyanbg.webp")`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
            }}
          >
            ...
            <div className="relative flex justify-center items-center h-75vh pb-16">
              ...
              <div className="flex w-3/4">
                ...
                <div className="w-1/2">
                  <h1
                    className="text-6xl font-bold bg-gradient-to-b from-blue-600 to-cyan-300 bg-clip-text text-transparent"
                    style={{
                      textShadow: "0px 0px 40px rgba(250,255,255,0.100)",
                      paddingTop: "10vh",
                      paddingBottom: "5vh",
                    }}
                  >
                  ...
                  <h2 className="w-full md:w-1/2 my-2 text-lg lg:text-xl font-normal text-default-800 block max-w-full !w-full text-center md:text-left">
                    This customer interface provides a modern dining experience
                    through intuitive system.
                  </h2>
                  <div
                    className="grid grid-cols-2 gap-4 mt-8"
                    style={{ paddingBottom: "5vh" }}
                  >
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Scan the QR code to access the menu and order directly
                          from your phone.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Add notes and special requests to your order for a
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Your order is sent directly to the chef, ensuring
                          prompt preparation.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Pay directly through the app or call a waiter for
                          assistance.
                        </p>
                      </CardBody>
                    </Card>
          ...
          <div
            ...
            className="relative h-screen"
            style={{
              backgroundImage: `url("/src/assets/yellowbg.webp")`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
            }}
          >
            ...
            <div className="relative flex justify-center items-center h-75vh pb-16">
              ...
              <div className="flex w-3/4">
                <div className="w-1/2">
                  <h1
                    className="text-6xl font-bold bg-gradient-to-b from-orange-600 to-yellow-600 bg-clip-text text-transparent"
                    style={{
                      textShadow: "0px 0px 40px rgba(250,255,255,0.100)",
                      paddingTop: "10vh",
                      paddingBottom: "5vh",
                  ...
                  <h2 className="w-full md:w-1/2 my-2 text-lg lg:text-xl font-normal text-default-600 block max-w-full !w-full text-center md:text-left">
                    This owner interface provides comprehensive tools for all
                  ...
                  >
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Add employees to the system, edit salaries, change
                          teams, and adjust shifts.
                        </p>
                      </CardBody>
                    </Card>
                    <Card
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Add and remove products, change prices, and implement
                          dynamic pricing.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Implement and manage dynamic pricing to maximize
                          revenue.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          View product performance, income reports, net profit,
          ...
          <div
            ...
            className="relative h-screen"
            style={{
              backgroundImage: `url("/src/assets/greenbg.webp")`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
            }}
          >
            ...
            <div className="relative flex justify-center items-center h-75vh pb-16">
              <div className="flex w-3/4">
                ...
                <div className="w-1/2">
                  <h1
                    className="text-6xl font-bold bg-gradient-to-b from-green-500 to-cyan-300 bg-clip-text text-transparent"
                    style={{
                      textShadow: "0px 0px 40px rgba(250,255,255,0.100)",
                      paddingTop: "10vh",
                      paddingBottom: "5vh",
                  ...
                  <h2 className="w-full md:w-1/2 my-2 text-lg lg:text-xl font-normal text-default-800 block max-w-full !w-full text-center md:text-left">
                    This waiter interface optimizes your workflow with intuitive
                    features.
                  </h2>
                  <div
                    className="grid grid-cols-2 gap-4 mt-8"
                  ...
                  >
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Receive directions on which table to attend and which
                          order to deliver.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Edit orders and ensure accurate delivery to the
                          correct table.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          Manage your tasks automatically and efficiently with
                          our system.
                        </p>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <p>
                          View customer details to provide personalized service
                          and suggestions.
                        </p>
                      </CardBody>
                    </Card>
          ...
          <div
            ...
            className="relative h-screen"
            style={{
              backgroundImage: `url("/src/assets/bluebg.webp")`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
            }}
          >
            <div className="absolute inset-0 bg-black opacity-50"></div>
            <div className="relative flex justify-center items-center min-h-screen pb-16">
              {" "}
              {/* Changed h-75vh to min-h-screen */}
              <div className="flex w-3/4">
                <div className="w-1/2">
                  <h1
                    className="text-6xl font-bold bg-gradient-to-b from-blue-900 to-blue-600 bg-clip-text text-transparent"
                    style={{
                      textShadow: "0px 0px 40px rgba(250,255,255,0.100)",
                      paddingTop: "10vh",
                      paddingBottom: "5vh",
                  ...
                  <h2 className="w-full md:w-1/2 my-2 text-lg lg:text-xl font-normal text-default-600 block max-w-full !w-full text-center md:text-left">
                    You may login to test our online demo, or continue as guest!
                  </h2>
                  <div
          ...
          <div id="support" className="about-us-section">
            ...
            <h1 className="text-lg lg:text-xl font-normal text-default-600">
              Contact the Orderly Team Directly!
            </h1>
          </div>
          <div
            className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 justify-center mx-auto"
            style={{ maxWidth: "75vw" }}
          >
            <Card>
              <CardHeader className="flex gap-3">
              ...
              <CardHeader className="flex gap-3">
                ...
                <div className="flex flex-col">
                  <Link
                    ...
                    color="foreground"
                    className="text-md"
                    href="https://discord.gg/hMWfK88qj5"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Discord
              ...
              <CardHeader className="flex gap-3">
                ...
                <div className="flex flex-col">
                  <Link
                    ...
                    color="foreground"
                    className="text-md"
                    href="mailto:a.foudhaily@stu.khas.edu.tr?subject=Contact%20Orderly"
                  >
                    Email
                  </Link>
                </div>
