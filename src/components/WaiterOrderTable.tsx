...
const OrderTable: React.FC<OrderTableProps> = ({ products }) => {
  ...
  const [statusFilter, setStatusFilter] = useState<Selection>(
    new Set(["in-kitchen", "order-ready", "delivered", "paid"])
  );
  const [categoryFilter, setCategoryFilter] = useState<Selection>(
    new Set(["Pizzas", "Pastas", "Desserts", "Beverages"])
  );
    ...
    return [...filteredProducts].sort((a, b) => {
      ...
      let primaryCmp =
        primaryFirst < primarySecond
          ...
          : 0;
      let secondaryCmp =
        secondaryFirst < secondarySecond
          ? -1
          : secondaryFirst > secondarySecond
          ? 1
          : 0;
      ...
      >
        ...
        <Dropdown>
          ...
          <DropdownMenu
            ...
            closeOnSelect={false}
          >
            <DropdownItem key="Pizzas">Pizzas</DropdownItem>
            <DropdownItem key="Pastas">Pastas</DropdownItem>
